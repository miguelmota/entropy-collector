(function(global) {
  ...
  function EntropyCollector() {
    // force instantiation of class if keyword `new` not used
    if (!(this instanceof EntropyCollector)) {
  ...
  if (typeof exports !== 'undefined') {
    if (typeof module !== 'undefined' && module.exports) {
      exports = module.exports = EntropyCollector;
    }
    ...
    global.EntropyCollector = EntropyCollector;
  }
})(self);
